  ...
  return (
    <section className="text-white body-font bg-black">
      <div className="p-4 pt-0 mt-5 mx-auto md:p-5 md:mx-20 lg:mx-32 xl:mx-56">
        ...
        <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="false" className="px-2 py-6 bg-gray-600 backdrop-blur-xl rounded-lg grid justify-center items-center grid-cols-3 gap-x-3 gap-y-6 sm:grid-cols-4 md:py-5 lg:grid-cols-5 xl:grid-cols-6 border-t-gray-200 border-2 shadow-xl ">
