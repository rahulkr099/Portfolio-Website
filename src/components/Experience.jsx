...
const  Experience = () => {
  ...
  return (
    <section className="py-3 px-3 bg-gray-900 mt-4 md:mt-7">
      <div className="mx-auto max-w-xl">
        <div id="experience" className="flex flex-col text-center mb-4 w-full ">
          <h1 className="text-3xl text-white sm:text-4xl font-medium title-font mb-2">
            Experience
          </h1>
          <p  className="text-lg mx-auto leading-relaxed font-medium text-dark-orange text-center">
            Professional Experience
          </p>
        </div>
        <div  className=" max-w-xl mx-auto p-4 rounded-xl shadow-md bg-slate-100">
          <div className="flex flex-col font-medium gap-1 w-full">
            <h1 className="text-xl md:text-2xl font-semibold">
              Full Stack Developer Intern
            </h1>
            <div className="flex items-center justify-center gap-3 text-lg text-white md:text-xl">
          ...
          <div className="flex w-fit mx-auto">
            <ul  className= "pl-3 md:pl-7 list-disc leading-loose max-w-max text-base text-justify md:text-start md:text-lg font-medium">
